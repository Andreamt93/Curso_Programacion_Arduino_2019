//   Detectar flancos ascendentes y descendentes,para reutilizarla en otros proyectos.
//  Unificar estas dos funciones en una única función "detectaFanco()" donde le paso el pin 
// y devuelve 1 si es flanco ascendente, -1 si es descendente y 0 si no hay cambios.
